      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="space-y-4">
          {analysisCards.map((card, index) => (
            <div 
              key={card.id} 
              className="bg-white rounded-lg shadow-sm p-4 hover:shadow-lg transition-shadow cursor-pointer border border-gray-200"
            >
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 mt-8 p-6">
          <div className="flex flex-col items-center text-center">
            <h3 className="text-lg font-medium mb-4">Shows all of the tuples found within the our database</h3>
